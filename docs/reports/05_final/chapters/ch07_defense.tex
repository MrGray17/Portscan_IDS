...
The honeypot interaction flag provides a measurable improvement: subsequent classifications on flows from IPs that previously touched a honeypot see an accuracy increase of 2.3\%, confirming that the defense subsystem feeds back useful signal into the detection pipeline.
