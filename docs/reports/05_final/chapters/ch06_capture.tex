...
% ============================================
% Condensed from Moulay Anas's main.tex (30+ pages → ~10 pages)
...
The laboratory relies on Oracle VirtualBox. Two virtual machines are configured with distinct roles:
