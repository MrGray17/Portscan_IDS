...
The retrained models were validated against the project's success criteria:
...
\midrule
Random Forest & 99.911\% & 99.920\% & 0.11\% & PASS \\
XGBoost & 99.914\% & 99.923\% & 0.11\% & PASS \\
Isolation Forest & 24.627\% & 31.720\% & 75.37\% & Expected (see Ch. 5) \\
\bottomrule
\end{tabular}
\end{table}
